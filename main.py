...
#database = r'C:\Users\TUF\OneDrive\Desktop\New folder\database'
...
class App:
    def __init__(self):
        ...
        self.input_name_widget = tk.Text()
        self.db_dir = './db'
    ...
    def register_new_user(self):
        ...
        self.accept_button_register_window = util.get_button(self.register_new_user_window, 'accept', 'green', self.accept_register_new_user )
        self.accept_button_register_window.place(x=750 , y=300)
        
        self.try_again_button_register_window = util.get_button(self.register_new_user_window , 'Try Again' , 'red' , self.try_again_register_new_user)
